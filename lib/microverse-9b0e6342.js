    ...
    */
    ...
    dragPlane(rayCaster, p3e){
        ...
        if(!this._plane) {
            ...
            let offset = (0,_worldcore__WEBPACK_IMPORTED_MODULE_0__.v3_dot)(p3e.xyz, normal);
            ...
            this._parentInvert = this._parent ? (0,_worldcore__WEBPACK_IMPORTED_MODULE_0__.m4_invert)(this._parent.global) : (0,_worldcore__WEBPACK_IMPORTED_MODULE_0__.m4_identity)();
            this.startDrag = (0,_worldcore__WEBPACK_IMPORTED_MODULE_0__.v3_transform)(p3e.xyz, this._parentInvert)
        ...
        let here = p.toArray();
        let localHere = (0,_worldcore__WEBPACK_IMPORTED_MODULE_0__.v3_transform)(here, this._parentInvert);
        let delta = (0,_worldcore__WEBPACK_IMPORTED_MODULE_0__.v3_sub)(localHere, this.startDrag);
        this.set({translation: (0,_worldcore__WEBPACK_IMPORTED_MODULE_0__.v3_add)(this._startTranslation, delta)});
    }
    ...
    rotatePlane(rayCaster, p3e){
        ...
        rayCaster.ray.intersectPlane(this._plane, p);
        let here = p.toArray();
        let delta = (0,_worldcore__WEBPACK_IMPORTED_MODULE_0__.v3_sub)(this.startDrag, here);
        delta[1] = 0;
        let angle = (0,_worldcore__WEBPACK_IMPORTED_MODULE_0__.v3_magnitude)(delta);
        let sign = (0,_worldcore__WEBPACK_IMPORTED_MODULE_0__.v3_cross)(p3e.lookNormal, delta)[1];
        if (sign < 0) angle = -angle;
        let qAngle = (0,_worldcore__WEBPACK_IMPORTED_MODULE_0__.q_euler)(0, angle, 0);
        this.set({rotation: (0,_worldcore__WEBPACK_IMPORTED_MODULE_0__.q_multiply)(this.baseRotation, qAngle)});
    }
