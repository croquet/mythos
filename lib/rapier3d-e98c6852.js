...
class RigidBodySet {
    ...
    createRigidBody(colliderSet, desc) {
        ...
        // #endif
        let handle = this.raw.createRigidBody(rawTra, rawRot, desc.gravityScale, desc.mass, desc.massOnly, rawCom, rawLv, 
        // #if DIM3
...
class ColliderSet {
    ...
    createCollider(bodies, desc, parentHandle) {
        ...
        let rawInertiaFrame = _math__WEBPACK_IMPORTED_MODULE_3__.RotationOps.intoRaw(desc.angularInertiaLocalFrame);
        // #endif
        let handle = this.raw.createCollider(rawShape, rawTra, rawRot, desc.massPropsMode, desc.mass, rawCom, 
        // #if DIM3
...
class QueryPipeline {
     ...
     */
    castShape(bodies, colliders, shapePos, shapeRot, shapeVel, shape, maxToi, filterFlags, filterGroups, filterExcludeCollider, filterExcludeRigidBody, filterPredicate) {
        let rawPos = _math__WEBPACK_IMPORTED_MODULE_1__.VectorOps.intoRaw(shapePos);
        let rawRot = _math__WEBPACK_IMPORTED_MODULE_1__.RotationOps.intoRaw(shapeRot);
        let rawVel = _math__WEBPACK_IMPORTED_MODULE_1__.VectorOps.intoRaw(shapeVel);
        let rawShape = shape.intoRaw();
        let result = _geometry__WEBPACK_IMPORTED_MODULE_4__.ShapeColliderTOI.fromRaw(colliders, this.raw.castShape(bodies.raw, colliders.raw, rawPos, rawRot, rawVel, rawShape, maxToi, filterFlags, filterGroups, filterExcludeCollider, filterExcludeRigidBody, filterPredicate));
        rawPos.free();
        rawRot.free();
        rawVel.free();
        rawShape.free();
...
class World {
    ...
    castRay(ray, maxToi, solid, filterFlags, filterGroups, filterExcludeCollider, filterExcludeRigidBody, filterPredicate) {
        return this.queryPipeline.castRay(this.bodies, this.colliders, ray, maxToi, solid, filterFlags, filterGroups, filterExcludeCollider ? filterExcludeCollider.handle : null, filterExcludeRigidBody ? filterExcludeRigidBody.handle : null, castClosure(this.colliders, filterPredicate));
    }
    /**
     * Find the closest intersection between a ray and the physics world.
     *
    ...
    castRayAndGetNormal(ray, maxToi, solid, filterFlags, filterGroups, filterExcludeCollider, filterExcludeRigidBody, filterPredicate) {
        return this.queryPipeline.castRayAndGetNormal(this.bodies, this.colliders, ray, maxToi, solid, filterFlags, filterGroups, filterExcludeCollider ? filterExcludeCollider.handle : null, filterExcludeRigidBody ? filterExcludeRigidBody.handle : null, castClosure(this.colliders, filterPredicate));
    }
    /**
     * Cast a ray and collects all the intersections between a ray and the scene.
     *
    ...
    intersectionsWithRay(ray, maxToi, solid, callback, filterFlags, filterGroups, filterExcludeCollider, filterExcludeRigidBody, filterPredicate) {
        this.queryPipeline.intersectionsWithRay(this.bodies, this.colliders, ray, maxToi, solid, callback, filterFlags, filterGroups, filterExcludeCollider ? filterExcludeCollider.handle : null, filterExcludeRigidBody ? filterExcludeRigidBody.handle : null, castClosure(this.colliders, filterPredicate));
    }
    /**
     * Gets the handle of up to one collider intersecting the given shape.
     *
    ...
    intersectionWithShape(shapePos, shapeRot, shape, filterFlags, filterGroups, filterExcludeCollider, filterExcludeRigidBody, filterPredicate) {
        let handle = this.queryPipeline.intersectionWithShape(this.bodies, this.colliders, shapePos, shapeRot, shape, filterFlags, filterGroups, filterExcludeCollider ? filterExcludeCollider.handle : null, filterExcludeRigidBody ? filterExcludeRigidBody.handle : null, castClosure(this.colliders, filterPredicate));
    ...
    projectPoint(point, solid, filterFlags, filterGroups, filterExcludeCollider, filterExcludeRigidBody, filterPredicate) {
        return this.queryPipeline.projectPoint(this.bodies, this.colliders, point, solid, filterFlags, filterGroups, filterExcludeCollider ? filterExcludeCollider.handle : null, filterExcludeRigidBody ? filterExcludeRigidBody.handle : null, castClosure(this.colliders, filterPredicate));
    }
    /**
     * Find the projection of a point on the closest collider.
     *
    ...
    projectPointAndGetFeature(point, filterFlags, filterGroups, filterExcludeCollider, filterExcludeRigidBody, filterPredicate) {
        return this.queryPipeline.projectPointAndGetFeature(this.bodies, this.colliders, point, filterFlags, filterGroups, filterExcludeCollider ? filterExcludeCollider.handle : null, filterExcludeRigidBody ? filterExcludeRigidBody.handle : null, castClosure(this.colliders, filterPredicate));
    }
    /**
     * Find all the colliders containing the given point.
     *
    ...
    intersectionsWithPoint(point, callback, filterFlags, filterGroups, filterExcludeCollider, filterExcludeRigidBody, filterPredicate) {
        this.queryPipeline.intersectionsWithPoint(this.bodies, this.colliders, point, castClosure(this.colliders, callback), filterFlags, filterGroups, filterExcludeCollider ? filterExcludeCollider.handle : null, filterExcludeRigidBody ? filterExcludeRigidBody.handle : null, castClosure(this.colliders, filterPredicate));
    }
    /**
     * Casts a shape at a constant linear velocity and retrieve the first collider it hits.
     * This is similar to ray-casting except that we are casting a whole shape instead of
     ...
     *   test on colliders with collision groups compatible with this group.
     */
    castShape(shapePos, shapeRot, shapeVel, shape, maxToi, filterFlags, filterGroups, filterExcludeCollider, filterExcludeRigidBody, filterPredicate) {
        return this.queryPipeline.castShape(this.bodies, this.colliders, shapePos, shapeRot, shapeVel, shape, maxToi, filterFlags, filterGroups, filterExcludeCollider ? filterExcludeCollider.handle : null, filterExcludeRigidBody ? filterExcludeRigidBody.handle : null, castClosure(this.colliders, filterPredicate));
    }
    /**
     * Retrieve all the colliders intersecting the given shape.
     *
    ...
    intersectionsWithShape(shapePos, shapeRot, shape, callback, filterFlags, filterGroups, filterExcludeCollider, filterExcludeRigidBody, filterPredicate) {
        this.queryPipeline.intersectionsWithShape(this.bodies, this.colliders, shapePos, shapeRot, shape, castClosure(this.colliders, callback), filterFlags, filterGroups, filterExcludeCollider ? filterExcludeCollider.handle : null, filterExcludeRigidBody ? filterExcludeRigidBody.handle : null, castClosure(this.colliders, filterPredicate));
    }
    /**
     * Finds the handles of all the colliders with an AABB intersecting the given AABB.
     *
...
/* harmony export */   "__wbg_bind_2ae44992222e2f45": () => (/* binding */ __wbg_bind_2ae44992222e2f45),
/* harmony export */   "__wbg_buffer_de1150f91b23aa89": () => (/* binding */ __wbg_buffer_de1150f91b23aa89),
/* harmony export */   "__wbg_call_0a54fa4fb42023f0": () => (/* binding */ __wbg_call_0a54fa4fb42023f0),
...
/* harmony export */   "__wbg_length_211080f5c116c01f": () => (/* binding */ __wbg_length_211080f5c116c01f),
...
/* harmony export */   "__wbg_newwithbyteoffsetandlength_b0ff18b468a0d3f8": () => (/* binding */ __wbg_newwithbyteoffsetandlength_b0ff18b468a0d3f8),
/* harmony export */   "__wbg_newwithlength_f28ac7a9191c7e26": () => (/* binding */ __wbg_newwithlength_f28ac7a9191c7e26),
...
/* harmony export */   "__wbg_set_66067e08ab6cefb5": () => (/* binding */ __wbg_set_66067e08ab6cefb5),
...
class RawColliderSet {
    ...
    */
    coCastShape(handle, colliderVel, shape2, shape2Pos, shape2Rot, shape2Vel, maxToi) {
        ...
        const ret = _rapier_wasm3d_bg_wasm__WEBPACK_IMPORTED_MODULE_0__.rawcolliderset_coCastShape(this.ptr, handle, colliderVel.ptr, shape2.ptr, shape2Pos.ptr, shape2Rot.ptr, shape2Vel.ptr, maxToi);
    ...
    */
    coCastCollider(handle, collider1Vel, collider2handle, collider2Vel, max_toi) {
        ...
        const ret = _rapier_wasm3d_bg_wasm__WEBPACK_IMPORTED_MODULE_0__.rawcolliderset_coCastCollider(this.ptr, handle, collider1Vel.ptr, collider2handle, collider2Vel.ptr, max_toi);
...
class RawContactForceEvent {
    ...
    */
    collider1() {
        const ret = _rapier_wasm3d_bg_wasm__WEBPACK_IMPORTED_MODULE_0__.rawcontactforceevent_collider1(this.ptr);
        return ret;
    }
    /**
    * The second collider involved in the contact.
...
class RawIntegrationParameters {
    ...
    */
    get erp() {
        const ret = _rapier_wasm3d_bg_wasm__WEBPACK_IMPORTED_MODULE_0__.rawintegrationparameters_erp(this.ptr);
        return ret;
    }
    /**
    */
...
class RawPointColliderProjection {
    ...
    */
    point() {
        const ret = _rapier_wasm3d_bg_wasm__WEBPACK_IMPORTED_MODULE_0__.rawpointcolliderprojection_point(this.ptr);
        return RawVector.__wrap(ret);
    }
    /**
    * @returns {boolean}
    */
    isInside() {
        const ret = _rapier_wasm3d_bg_wasm__WEBPACK_IMPORTED_MODULE_0__.rawpointcolliderprojection_isInside(this.ptr);
        return ret !== 0;
    }
    /**
    * @returns {number}
...
class RawPointProjection {
    ...
    */
    point() {
        const ret = _rapier_wasm3d_bg_wasm__WEBPACK_IMPORTED_MODULE_0__.rawpointprojection_point(this.ptr);
        return RawVector.__wrap(ret);
    }
    /**
    * @returns {boolean}
    */
    isInside() {
        const ret = _rapier_wasm3d_bg_wasm__WEBPACK_IMPORTED_MODULE_0__.rawpointprojection_isInside(this.ptr);
        return ret !== 0;
    }
}
/**
    ...
    */
    castShape(bodies, colliders, shapePos, shapeRot, shapeVel, shape, maxToi, filter_flags, filter_groups, filter_exclude_collider, filter_exclude_rigid_body, filter_predicate) {
        try {
            ...
            _assertClass(shape, RawShape);
            const ret = _rapier_wasm3d_bg_wasm__WEBPACK_IMPORTED_MODULE_0__.rawquerypipeline_castShape(this.ptr, bodies.ptr, colliders.ptr, shapePos.ptr, shapeRot.ptr, shapeVel.ptr, shape.ptr, maxToi, filter_flags, !isLikeNone(filter_groups), isLikeNone(filter_groups) ? 0 : filter_groups, !isLikeNone(filter_exclude_collider), isLikeNone(filter_exclude_collider) ? 0 : filter_exclude_collider, !isLikeNone(filter_exclude_rigid_body), isLikeNone(filter_exclude_rigid_body) ? 0 : filter_exclude_rigid_body, addBorrowedObject(filter_predicate));
            return ret === 0 ? undefined : RawShapeColliderTOI.__wrap(ret);
        } finally {
            heap[stack_pointer++] = undefined;
        }
...
class RawRayIntersection {
    ...
    */
    normal() {
        const ret = _rapier_wasm3d_bg_wasm__WEBPACK_IMPORTED_MODULE_0__.rawrayintersection_normal(this.ptr);
        return RawVector.__wrap(ret);
    }
    /**
    * @returns {number}
...
class RawRigidBodySet {
    ...
    */
    rbSetBodyType(handle, status) {
        _rapier_wasm3d_bg_wasm__WEBPACK_IMPORTED_MODULE_0__.rawrigidbodyset_rbSetBodyType(this.ptr, handle, status);
    }
    /**
...
class RawShape {
    ...
    */
    castShape(shapePos1, shapeRot1, shapeVel1, shape2, shapePos2, shapeRot2, shapeVel2, maxToi) {
        ...
        const ret = _rapier_wasm3d_bg_wasm__WEBPACK_IMPORTED_MODULE_0__.rawshape_castShape(this.ptr, shapePos1.ptr, shapeRot1.ptr, shapeVel1.ptr, shape2.ptr, shapePos2.ptr, shapeRot2.ptr, shapeVel2.ptr, maxToi);
        return ret === 0 ? undefined : RawShapeTOI.__wrap(ret);
    }
    /**
    * @param {RawVector} shapePos1
...
class RawShapeColliderTOI {
    ...
    */
    normal1() {
        const ret = _rapier_wasm3d_bg_wasm__WEBPACK_IMPORTED_MODULE_0__.rawshapecollidertoi_normal1(this.ptr);
        return RawVector.__wrap(ret);
    }
    /**
    * @returns {RawVector}
...
class RawShapeContact {
    ...
    */
    point2() {
        const ret = _rapier_wasm3d_bg_wasm__WEBPACK_IMPORTED_MODULE_0__.rawshapecontact_point2(this.ptr);
        return RawVector.__wrap(ret);
    }
    /**
    * @returns {RawVector}
    */
    normal1() {
        const ret = _rapier_wasm3d_bg_wasm__WEBPACK_IMPORTED_MODULE_0__.rawshapecontact_normal1(this.ptr);
        return RawVector.__wrap(ret);
    }
    /**
    * @returns {RawVector}
    */
    normal2() {
        const ret = _rapier_wasm3d_bg_wasm__WEBPACK_IMPORTED_MODULE_0__.rawshapecontact_normal2(this.ptr);
        return RawVector.__wrap(ret);
    }
}
/**
...
class RawShapeTOI {
    ...
    */
    witness2() {
        const ret = _rapier_wasm3d_bg_wasm__WEBPACK_IMPORTED_MODULE_0__.rawshapetoi_witness2(this.ptr);
        return RawVector.__wrap(ret);
    }
    /**
    * @returns {RawVector}
...
function __wbg_call_0a54fa4fb42023f0() { return handleError(function (arg0, arg1, arg2, arg3, arg4) {
    const ret = getObject(arg0).call(getObject(arg1), getObject(arg2), getObject(arg3), getObject(arg4));
    return addHeapObject(ret);
}, arguments) };

function __wbg_bind_2ae44992222e2f45(arg0, arg1, arg2, arg3) {
...
var __webpack_instantiate__ = ([WEBPACK_IMPORTED_MODULE_0]) => {
	return __webpack_require__.v(exports, module.id, "414b4082c7d78572771d", {
		"./rapier_wasm3d_bg.js": {
			...
			"__wbg_call_9855a4612eb496cb": WEBPACK_IMPORTED_MODULE_0.__wbg_call_9855a4612eb496cb,
			"__wbg_call_8e1338b908441bd2": WEBPACK_IMPORTED_MODULE_0.__wbg_call_8e1338b908441bd2,
			"__wbg_call_0a54fa4fb42023f0": WEBPACK_IMPORTED_MODULE_0.__wbg_call_0a54fa4fb42023f0,
			"__wbg_bind_2ae44992222e2f45": WEBPACK_IMPORTED_MODULE_0.__wbg_bind_2ae44992222e2f45,
			"__wbg_buffer_de1150f91b23aa89": WEBPACK_IMPORTED_MODULE_0.__wbg_buffer_de1150f91b23aa89,
			"__wbg_newwithbyteoffsetandlength_9ca61320599a2c84": WEBPACK_IMPORTED_MODULE_0.__wbg_newwithbyteoffsetandlength_9ca61320599a2c84,
			"__wbg_new_97cf52648830a70d": WEBPACK_IMPORTED_MODULE_0.__wbg_new_97cf52648830a70d,
			"__wbg_set_a0172b213e2469e9": WEBPACK_IMPORTED_MODULE_0.__wbg_set_a0172b213e2469e9,
			"__wbg_length_e09c0b925ab8de5d": WEBPACK_IMPORTED_MODULE_0.__wbg_length_e09c0b925ab8de5d,
			"__wbg_newwithbyteoffsetandlength_b0ff18b468a0d3f8": WEBPACK_IMPORTED_MODULE_0.__wbg_newwithbyteoffsetandlength_b0ff18b468a0d3f8,
			"__wbg_set_66067e08ab6cefb5": WEBPACK_IMPORTED_MODULE_0.__wbg_set_66067e08ab6cefb5,
			"__wbg_length_211080f5c116c01f": WEBPACK_IMPORTED_MODULE_0.__wbg_length_211080f5c116c01f,
			"__wbg_newwithlength_f28ac7a9191c7e26": WEBPACK_IMPORTED_MODULE_0.__wbg_newwithlength_f28ac7a9191c7e26,
...
__webpack_require__.a(module, async (__webpack_handle_async_dependencies__, __webpack_async_result__) => {
	...
	await __webpack_require__.v(exports, module.id, "414b4082c7d78572771d", {
		"./rapier_wasm3d_bg.js": {
			"__wbindgen_object_drop_ref": WEBPACK_IMPORTED_MODULE_0.__wbindgen_object_drop_ref,
			"__wbindgen_number_new": WEBPACK_IMPORTED_MODULE_0.__wbindgen_number_new,
			"__wbindgen_number_get": WEBPACK_IMPORTED_MODULE_0.__wbindgen_number_get,
